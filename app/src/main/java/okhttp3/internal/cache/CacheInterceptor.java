...
public final class CacheInterceptor implements Interceptor {
    ...
    static boolean isEndToEnd(String str) {
        return !"Connection".equalsIgnoreCase(str) && !HTTP.CONN_KEEP_ALIVE.equalsIgnoreCase(str) && !"Proxy-Authenticate".equalsIgnoreCase(str) && !"Proxy-Authorization".equalsIgnoreCase(str) && !cz.msebera.android.httpclient.HttpHeaders.TE.equalsIgnoreCase(str) && !"Trailers".equalsIgnoreCase(str) && !"Transfer-Encoding".equalsIgnoreCase(str) && !cz.msebera.android.httpclient.HttpHeaders.UPGRADE.equalsIgnoreCase(str);
    }
}
