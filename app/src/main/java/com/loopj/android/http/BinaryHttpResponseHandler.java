...
public abstract class BinaryHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public BinaryHttpResponseHandler() {
        this.mAllowedContentTypes = new String[]{"application/octet-stream", HWOkHttpMimeType.MIME_IMAGE_JPEG, HWOkHttpMimeType.MIME_IMAGE_PNG, HWOkHttpMimeType.MIME_IMAGE_GIF};
    }
