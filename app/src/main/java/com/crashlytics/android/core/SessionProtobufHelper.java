...
public class SessionProtobufHelper {
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, ByteString byteString2, int i2, long j, long j2, boolean z, Map<IdManager.DeviceIdentifierType, String> map, int i3, ByteString byteString3, ByteString byteString4) {
        ...
        int computeUInt32Size = computeBytesSize + CodedOutputStream.computeUInt32Size(12, i3) + (byteString3 == null ? 0 : CodedOutputStream.computeBytesSize(13, byteString3));
        if (byteString4 != null) {
            i4 = CodedOutputStream.computeBytesSize(14, byteString4);
        }
