    ...
    */
    public int getOrientation(android.net.Uri r7) {
        /*
            r6 = this;
            r0 = 0
            android.content.ContentResolver r1 = r6.contentResolver     // Catch: all -> 0x0017, IOException | NullPointerException -> 0x001a
            java.io.InputStream r1 = r1.openInputStream(r7)     // Catch: all -> 0x0017, IOException | NullPointerException -> 0x001a
            java.util.List<com.bumptech.glide.load.ImageHeaderParser> r0 = r6.parsers     // Catch: IOException | NullPointerException -> 0x0015, all -> 0x0044
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r2 = r6.byteArrayPool     // Catch: IOException | NullPointerException -> 0x0015, all -> 0x0044
            int r0 = com.bumptech.glide.load.ImageHeaderParserUtils.getOrientation(r0, r1, r2)     // Catch: IOException | NullPointerException -> 0x0015, all -> 0x0044
