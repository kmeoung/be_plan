...
public final class zzcfz {
    ...
    public static zzcga<String> zzixm = zzcga.zzi("measurement.config.url_scheme", "https", "https");
    public static zzcga<String> zzixn = zzcga.zzi("measurement.config.url_authority", "app-measurement.com", "app-measurement.com");
    ...
    public static zzcga<Integer> zzixv = zzcga.zzm("measurement.upload.max_conversions_per_day", HttpStatus.SC_INTERNAL_SERVER_ERROR, HttpStatus.SC_INTERNAL_SERVER_ERROR);
    ...
    public static zzcga<String> zzixy = zzcga.zzi("measurement.upload.url", "https://app-measurement.com/a", "https://app-measurement.com/a");
