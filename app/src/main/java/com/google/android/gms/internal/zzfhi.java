...
public final class zzfhi {
    ...
    public static final Object zzphg = new Object();
    ...
    public static void zza(zzfhe zzfheVar, zzfhe zzfheVar2) {
        if (zzfheVar.zzpgy != null) {
            zzfheVar2.zzpgy = (zzfhg) zzfheVar.zzpgy.clone();
        }
    }
