...
public final class FirebaseAnalytics {
    ...
    public final Task<String> getAppInstanceId() {
        return this.zzitk.zzawa().getAppInstanceId();
    }

    public final void logEvent(@Size(max = 40, min = 1) @NonNull String str, Bundle bundle) {
        this.zzitk.zzazn().logEvent(str, bundle);
    }

    public final void resetAnalyticsData() {
        this.zzitk.zzawa().resetAnalyticsData();
    }

    public final void setAnalyticsCollectionEnabled(boolean z) {
        this.zzitk.zzazn().setMeasurementEnabled(z);
    }
    ...
    public final void setMinimumSessionDuration(long j) {
        this.zzitk.zzazn().setMinimumSessionDuration(j);
    }

    public final void setSessionTimeoutDuration(long j) {
        this.zzitk.zzazn().setSessionTimeoutDuration(j);
    }

    public final void setUserId(String str) {
        this.zzitk.zzazn().setUserPropertyInternal(SettingsJsonConstants.APP_KEY, "_id", str);
    }

    public final void setUserProperty(@Size(max = 24, min = 1) @NonNull String str, @Size(max = 36) @Nullable String str2) {
        this.zzitk.zzazn().setUserProperty(str, str2);
    }
}
