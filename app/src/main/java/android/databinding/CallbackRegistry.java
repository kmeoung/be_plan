...
public class CallbackRegistry<C, T, A> implements Cloneable {
    ...
    private boolean isRemoved(int i) {
        int i2;
        return i < 64 ? (this.mFirst64Removed & (1 << i)) != 0 : (this.mRemainderRemoved == null || (i2 = (i / 64) - 1) >= this.mRemainderRemoved.length || (this.mRemainderRemoved[i2] & (1 << (i % 64))) == 0) ? false : true;
    }
