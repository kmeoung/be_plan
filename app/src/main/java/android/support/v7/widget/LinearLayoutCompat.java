...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    void measureVertical(int r40, int r41) {
        /*
    ...
    */
    ...
    void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        if (i8 != 16) {
            i5 = i8 != 80 ? getPaddingTop() : ((getPaddingTop() + i4) - i2) - this.mTotalLength;
        } else {
        ...
        while (i10 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                setChildFrame(virtualChildAt, i6, i11 + getLocationOffset(virtualChildAt), measuredWidth, measuredHeight);
                i5 = i11 + measuredHeight + layoutParams.bottomMargin + getNextLocationOffset(virtualChildAt);
