    ...
    */
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == 1) {
                if (layoutParams.mFullSpan) {
                    i9 = getMaxEnd(startAfterPadding);
                } else {
                    i9 = span.getEndLine(startAfterPadding);
                }
                i3 = this.mPrimaryOrientation.getDecoratedMeasurement(next) + i9;
                if (z3 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem createFullSpanItemFromEnd = createFullSpanItemFromEnd(i9);
                ...
                if (layoutParams.mFullSpan) {
                    i8 = getMinStart(startAfterPadding);
                } else {
                    i8 = span.getStartLine(startAfterPadding);
                }
                i4 = i8 - this.mPrimaryOrientation.getDecoratedMeasurement(next);
                if (z3 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem createFullSpanItemFromStart = createFullSpanItemFromStart(i8);
            ...
            if (!isLayoutRTL() || this.mOrientation != 1) {
                ...
                i6 = endAfterPadding - this.mSecondaryOrientation.getDecoratedMeasurement(next);
                i5 = endAfterPadding;
            }
            if (this.mOrientation == 1) {
