    ...
    private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() { // from class: android.support.design.widget.BottomSheetBehavior.2
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            if (BottomSheetBehavior.this.mState != 1 && !BottomSheetBehavior.this.mTouchingScrollingChild) {
                return (BottomSheetBehavior.this.mState != 3 || BottomSheetBehavior.this.mActivePointerId != i || (view2 = BottomSheetBehavior.this.mNestedScrollingChildRef.get()) == null || !view2.canScrollVertically(-1)) && BottomSheetBehavior.this.mViewRef != null && BottomSheetBehavior.this.mViewRef.get() == view;
            }
            return false;
        }
