...
public class ConstraintLayout extends ViewGroup {
            ...
            if (viewWidget2 != null) {
                ...
                if (layoutParams.helped) {
                    ...
                    try {
                        ...
                        int i16 = z ? 1 : 0;
                        int i17 = z ? 1 : 0;
                        setDesignInformation(i11, resourceName2, valueOf);
                ...
                if (!layoutParams.isGuideline && !layoutParams.isHelper) {
                    ...
                    if (layoutParams.horizontalDimensionFixed || layoutParams.verticalDimensionFixed || (!layoutParams.horizontalDimensionFixed && layoutParams.matchConstraintDefaultWidth == 1) || layoutParams.width == -1 || (!layoutParams.verticalDimensionFixed && (layoutParams.matchConstraintDefaultHeight == 1 || layoutParams.height == -1))) {
                        if (i7 == 0) {
                            ...
                            z2 = i7 == -2;
                            i3 = getChildMeasureSpec(i5, paddingLeft, i7);
                        }
                        if (i8 == 0) {
                            ...
                            z = i8 == -2;
                            i4 = getChildMeasureSpec(i2, paddingTop, i8);
                        }
                    ...
                    if (z) {
                        constraintWidget.setWrapHeight(i8);
                    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:158:0x0310 A[ADDED_TO_REGION] */
    /*
