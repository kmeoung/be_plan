...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        if (z2) {
            ...
            width = i14 + ((i == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i8);
        }
        int i15 = 1;
        if (i == 1) {
            ...
            while (it3.hasNext()) {
                ...
                if (i8 == i15) {
                    ...
                    i7 = i7;
                    i16 = Math.max(i16, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, (i5 * i8) + i13));
                }
                it3 = it3;
                i15 = 1;
            }
            i9 = i7;
            i10 = (constraintWidget.mBaseline.getResolutionNode().dependents.size() <= 0 || z2) ? i16 : i8 == 1 ? i16 + i6 : i16 - i5;
        } else {
            i9 = i7;
            i10 = 0;
        }
        int max = margin + Math.max(i11, Math.max(width, i10));
        int i17 = i13 + width2;
        if (i8 == -1) {
            i13 = i17;
            i17 = i13;
