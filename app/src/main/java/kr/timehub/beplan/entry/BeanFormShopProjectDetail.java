...
public class BeanFormShopProjectDetail {
    private int BoughtConfirmCount;
    ...
    private String ShopProjectTitle;
    ...
    public int getBoughtConfirmCount() {
        return this.BoughtConfirmCount;
    }

    public void setBoughtConfirmCount(int i) {
        this.BoughtConfirmCount = i;
    }
    ...
    public String getShopProjectTitle() {
        return this.ShopProjectTitle;
    }

    public void setShopProjectTitle(String str) {
        this.ShopProjectTitle = str;
    }
