...
public class BeanShopProject {
    ...
    public static class CateGoryListBean {
        ...
        public String getProjectMemberAuth() {
            return this.ProjectMemberAuth;
        }

        public void setProjectMemberAuth(String str) {
            this.ProjectMemberAuth = str;
        }
        ...
        public String getSellAuth() {
            return this.SellAuth;
        }

        public void setSellAuth(String str) {
            this.SellAuth = str;
        }
